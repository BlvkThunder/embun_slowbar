...
--
-- Host: db
-- Generation Time: Dec 12, 2025 at 12:47 PM
...
CREATE TABLE `loans` (
  ...
  `borrower_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `user_id` int NOT NULL,
  `borrow_date` date NOT NULL,
  `due_date` date NOT NULL,
  `return_date` date DEFAULT NULL,
  `final_fine` int DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `option_types` (
  ...
  `applies_from_category` int DEFAULT NULL,
  `applies_to_category` int DEFAULT NULL,
  `values_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `price_per_selected` int DEFAULT '0',
...
CREATE TABLE `orders` (
  ...
  `amount` int NOT NULL,
  `status` enum('pending','paid','expired','failed','cancelled') COLLATE utf8mb4_general_ci DEFAULT 'pending',
  `payment_type` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `transaction_time` datetime DEFAULT NULL,
  `va_numbers` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `snap_token` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `order_items_json` text COLLATE utf8mb4_general_ci,
  `snap_response` longtext COLLATE utf8mb4_general_ci,
  `wa_number` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL
) ;
...
CREATE TABLE `orders_history` (
  ...
  `payment_type` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `transaction_time` datetime DEFAULT NULL,
  `va_numbers` text COLLATE utf8mb4_general_ci,
  `snap_token` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `order_items_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `snap_response` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `wa_number` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `order_item_options` (
  ...
  `option_key` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `payment_logs` (
  `id` int NOT NULL,
  `order_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
  `raw_payload` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `reservations` (
  ...
  `book_id` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `reservations_history` (
  ...
  `user_id` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `whatsapp` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `website_content` (
  ...
  `content_type` enum('text','image','html') COLLATE utf8mb4_general_ci DEFAULT 'text',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
